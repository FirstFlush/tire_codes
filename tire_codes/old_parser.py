...
from .old_regex import TireCodeRegex
...
class TireCodeParser:
    ...
    *args/**kwargs : 
    ...
    def _pattern_to_method_mapping(self) -> dict[Pattern, Callable]:
        """Creates a mapping between regex patterns and their corresponding methods.

        Since tire codes can vary in the information they contain, different regex patterns
        are used to match different sets of tire data. This mapping associates each 
        regex pattern with the appropriate method for populating tire specs based on the 
        specific data set identified by the pattern.
        """
        return {
